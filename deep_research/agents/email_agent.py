...
from services.messenger import send_email, push
import os
...
email_agent = Agent(name="Email Agent", instructions=INSTRUCTIONS, tools=[send_email_tool], model=openrouter_model, model_settings=settings)